...
<body>
    ...
    <div id="article-modal" class="modal">
        <div class="modal-content">
            ...
            <h2 class="mb-12"><span>Add Article</span></h2>
            <form action="php/article.php" method="POST" enctype="multipart/form-data">
                <div class="grid grid-container mb-12">
                    ...
                    <div class="col">
                        <label for="upload-img">Upload Article Image</label>
                ...
                <div class="flex">
                    <button id="add-article-btn" name="add-article" class="btn-secondary">Submit</button>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="grid grid-container mb-12">
                <div class="col">
                    ...
                    <div class="flex align-center">
                        <div class="me-3">
                            <p id="read-more-category" class="inline-block border rounded-pill py-1 px-4"></p>
                        </div>
    ...
    <!-- Filter -->
    <form id="filter-form" action="article.php" method="GET">
        <div class="container grid grid-container mb-6">
            ...
            <select id="category-filter" class="col-span-6" name="category">
    ...
    <div class="container">
        ...
        if ($_SESSION['acc_type'] == 'doctor') {
            $doctor_id = $_SESSION['id'];
            $sql .= " AND created_by = '$doctor_id'";
        }
        ...
        ?>
            <div class="list">
                ...
                <div>
                    ...
                    <div class="mb-6">
                        <buttton class="read-more-btn" data-id="<?php echo $row['article_id']; ?>">Read More</button>
                    </div>
                    <div class="flex space-x-4">
                        <div>
                            <h5>Created By</h5>
                        ...
                        <div>
                            <?php if ($row['published_at'] != "") { ?>
                                <h5>Published At</h5>
                                <p><?php echo $row['published_at']; ?></p>
                            <?php } ?>
                        </div>
                    </div>
                    <?php if ($_SESSION['acc_type'] == 'admin') { ?>
                        <div>
                            ...
                            <?php if ($row['status'] == "Pending") { ?>
                                <span>
                                    <button id="Approved" class="article-status btn btn-square" data-id="<?php echo $row['article_id'] ?>"><i class="fas fa-check"></i></button>
                                </span>
                                <span>
                                    <button id="Rejected" class="article-status btn btn-square" data-id="<?php echo $row['article_id'] ?>"><i class="fas fa-times"></i></button>
                                </span>
                            <?php } ?>
                        </div>
                    <?php } ?>
        ...
        <?php if ($result->num_rows == 0) { ?>
            <div class="flex flex-col center">
                ...
                <h2 class="mt-4">No article found</h2>
            </div>
        <?php } ?>
    ...
    <?php if ($_SESSION['acc_type'] == 'doctor') { ?>
        <div class="container flex mb-6">
            <button id="article-btn" class="btn-secondary ml-auto">Upload Article</button>
        </div>
    <?php } ?>
